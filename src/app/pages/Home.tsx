...
export default function Home() {
  ...
  const testimonials = [
    {
      name: "Trần Thị Tâm Tâm",
      role: "Software Engineer",
      content: "Tôi đã tìm thấy một căn hộ tuyệt vời thông qua RentAI. Quá trình tìm kiếm và ký hợp đồng diễn ra suôn sẻ, và tôi rất hài lòng với sự hỗ trợ 24/7 của họ.",
      rating: 5,
    },
    {
      name: "Nguyễn Văn Anh Tài",
      role: "Designer",
      content: "Sự hỗ trợ 24/7 là một bước đột phá. Tôi có một sự cố về ống nước vào giữa đêm và nó được giải quyết vào sáng hôm sau.",
      rating: 5,
    },
    {
      name: "Lê Thị Tuyết Trinh",
      role: "Teacher",
      content: "Tôi đã sử dụng tính năng tìm kiếm thông minh của RentAI và nó đã giúp tôi tìm được một căn hộ phù hợp với ngân sách và sở thích của tôi chỉ trong vài phút.",
      rating: 5,
    },
  ];
